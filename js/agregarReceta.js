function inicializarAgregarReceta() {
  ...
  $("#formReceta").on("submit", function (event) {
    ...
    function enviarImagen(idreceta) {
      ...
      $.ajax({
        url: "../controllers/ctr_receta.php?action=agregarImagen", // Ruta donde se enviará la solicitud
        type: "POST",
        data: formData,
    ...
    function guardarIngredientes(id_receta) {
      ...
      $.ajax({
        url: "../controllers/ctr_ingrediente.php",
        type: "POST",
    ...
    $.ajax({
      url: "../controllers/ctr_receta.php?action=agregarReceta",
      type: "POST",
      data: jsonData,
